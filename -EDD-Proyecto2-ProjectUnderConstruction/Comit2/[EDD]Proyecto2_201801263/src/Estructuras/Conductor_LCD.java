...
public class Conductor_LCD {
    ...
    public void InsertarConductor(String DPI, String Nombre, String Apellido, String tipoLicencia, String genero,String Fecha ,int Telefono, String Direccion){
        nodoConductor Nuevo = new nodoConductor(DPI, Nombre, Apellido, tipoLicencia, genero, Fecha, Telefono, Direccion);
    ...
    void  Editar(String dpi,  String Nombre, String Apellido, String tipoLicencia, String genero,String fecha, int Telefono, String Direccion ){
        nodoConductor actual = new nodoConductor();
        actual= ini;
        do{
            if(actual.getDPI()==dpi){
